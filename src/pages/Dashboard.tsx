...
const Dashboard = () => {
  ...
  return <div className="space-y-8 bg-slate-50 min-h-screen p-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {stats.map(stat => <Card key={stat.title} className={`${stat.color} border-0 shadow-lg hover:shadow-xl transition-shadow duration-200`}>
      ...
      <Card className="shadow-sm border-0 bg-white">
        <CardHeader className="border-b border-slate-100">
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-lg font-semibold text-slate-800">Registered users and Reports</CardTitle>
